...
pub fn open_header(filepath: &str) -> CIAHeaderInfo {
...
mod tests {
    ...
    #[test]
    fn it_works() {
        let info = open_header("E:/gm9/out/0004000000126100_v00.standard.cia");
    }
}
